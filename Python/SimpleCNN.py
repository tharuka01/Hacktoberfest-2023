...
train_data=datasets.MNIST(root=r"C:\Users\hp\Downloads\ML\Data",train=True, transform=transform,download=False)
test_data=datasets.MNIST(root=r"C:\Users\hp\Downloads\ML\ata",train=False, transform=transform,download=False)
